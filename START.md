...
| Notifications | [localhost/parent/notifications](http://localhost:3000/parent/notifications) | [app.../parent/notifications](https://app.kita-connect.cloud/parent/notifications) |
...
| Groups | [localhost/teacher/groups](http://localhost:3000/teacher/groups) | [app.../teacher/groups](https://app.kita-connect.cloud/teacher/groups) |
| Broadcast | [localhost/teacher/broadcast](http://localhost:3000/teacher/broadcast) | [app.../teacher/broadcast](https://app.kita-connect.cloud/teacher/broadcast) |
| Meals | [localhost/teacher/meals](http://localhost:3000/teacher/meals) | [app.../teacher/meals](https://app.kita-connect.cloud/teacher/meals) |
| Settings | [localhost/teacher/settings](http://localhost:3000/teacher/settings) | [app.../teacher/settings](https://app.kita-connect.cloud/teacher/settings) |
...
| Page | Local | Production |
|------|-------|------------|
| Dashboard | [localhost/admin](http://localhost:3000/admin) | [app.../admin](https://app.kita-connect.cloud/admin) |
| Parents | [localhost/admin/parents](http://localhost:3000/admin/parents) | [app.../admin/parents](https://app.kita-connect.cloud/admin/parents) |
| Invitations | [localhost/admin/invitations](http://localhost:3000/admin/invitations) | [app.../admin/invitations](https://app.kita-connect.cloud/admin/invitations) |
| Broadcast | [localhost/admin/broadcast](http://localhost:3000/admin/broadcast) | [app.../admin/broadcast](https://app.kita-connect.cloud/admin/broadcast) |
| Meals | [localhost/admin/meals](http://localhost:3000/admin/meals) | [app.../admin/meals](https://app.kita-connect.cloud/admin/meals) |
| Settings | [localhost/admin/settings](http://localhost:3000/admin/settings) | [app.../admin/settings](https://app.kita-connect.cloud/admin/settings) |
